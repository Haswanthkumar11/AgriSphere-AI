...
3. Nikhil   (Farmer)  - 7989612530 / password123
"""
...
def seed_demo_data(db: Session) -> None:
    ...
    seed_accounts = [
        {"name": "Haswanth", "phone": "8310557227", "role": "admin",   "crop": "Tomato", "land": 5.0},
        {"name": "Sandya",   "phone": "9121679411", "role": "officer", "crop": "Paddy",  "land": 2.5},
        {"name": "Nikhil",   "phone": "7989612530", "role": "farmer",  "crop": "Chilli", "land": 3.0},
    ]
    ...
    for acc in seed_accounts:
        ...
        if not user:
            ...
            if acc["role"] == "farmer":
                farmer_domain = Farmer(user_id=user.id, crop_type=acc["crop"], land_size=acc["land"])
